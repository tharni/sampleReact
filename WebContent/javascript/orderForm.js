...
var ServiceChooser = React.createClass({
    ...
    render: function() {
        ...
        var services = this.props.items.map(function(s){
            ...
            return <Service key={s.key} name={s.name} price={s.price} active={s.active} addTotal={self.addTotal} />;
        });
...
var services = [
    { key:1, name: 'Web Development', price: 300 },
    { key:2, name: 'Design', price: 400 },
    { key:3, name: 'Integration', price: 250 },
    { key:4, name: 'Training', price: 220 }
];
